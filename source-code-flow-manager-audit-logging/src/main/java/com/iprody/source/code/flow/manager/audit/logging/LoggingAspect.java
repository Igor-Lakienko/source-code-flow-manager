...
public class LoggingAspect {
    ...
    public void beforeAllAspectsAdvice(JoinPoint joinPoint) {
        final var operationName = getOperationName(joinPoint);
    ...
    public void beforeExecutionMethodWithLogOperationAnnotationAdvice(JoinPoint joinPoint) {
        final var methodName = getLoggedMethodName(joinPoint);
        final var methodArguments = getLoggedMethodArguments(joinPoint).orElse("");
        final var logger = getLoggingOperationLogger(joinPoint).orElse(log);
    ...
    private String getOperationName(JoinPoint joinPoint) {
        ...
        final var nameFromLogOperationAnnotation = methodSignature.getMethod()
    ...
    private String getLoggedMethodName(JoinPoint joinPoint) {
        ...
        final var nameFromLogOperationAnnotation = methodSignature.getMethod()
                .getAnnotation(LogOperation.class).name();
        final var fullQualifiedMethodName = getFullQualifiedMethodName(joinPoint, methodSignature);
